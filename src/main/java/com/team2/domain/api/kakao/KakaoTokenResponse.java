...
public class KakaoTokenResponse {
	String token_type, access_token, id_token, refresh_token, scope, code;
	int expires_in, refresh_token_expires_in;
	...
	public String toString() {
		return "KakaoTokenResponse [token_type=" + token_type + ", access_token=" + access_token + ", id_token="
				+ id_token + ", refresh_token=" + refresh_token + ", scope=" + scope + ", expires_in=" + expires_in
